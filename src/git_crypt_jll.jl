...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import git_crypt_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cc44a8f6-01aa-5a07-9bbc-f33bd50aae3d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "git_crypt", artifacts_toml) for e in artifacts["git_crypt"]]
...
if best_platform === nothing
    @debug("Unable to load git_crypt; unsupported platform $(triplet(platform_key_abi()))")
else
